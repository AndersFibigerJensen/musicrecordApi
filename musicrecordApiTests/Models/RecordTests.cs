...
namespace musicrecordApi.Models.Tests
{
    ...
    public class RecordTests
    {
        ...
        public void ValidateTitleTest()
        {
            ...
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => record3.ValidateTitle());
        }
        ...
        public void ArtistValidateTest()
        {
            ...
            Assert.ThrowsException<ArgumentNullException>(() => record2.ArtistValidate());
            Assert.ThrowsException<ArgumentOutOfRangeException>(() => record3.ArtistValidate());
        }
    }
}